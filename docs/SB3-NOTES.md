...
https://wiki.anime-sharing.com/hgames/index.php?title=Sexy_Beach_3/Modding
...
3	File overviews
4	sb3_0000
4.1	lb??_00_00_00_00.lst
4.1.1	A~H
4.1.2	I~Z - Interactions
4.1.3	AB~AL - See-through when wet
4.1.4	AN ~ AX
4.1.5	AZ ~ BI
4.2	lc00_00_00_00_00.lst
4.3	ld00_00_00_00_00.lst
4.4	ld01_??_00_00_00.lst
4.5	lf01_00_00_00_00.lst
4.5.1	The default interactions
4.5.2	The columns
4.6	lh??_00_00_00_00.lst
4.7	lp0?_0?_0?_00_00.lst
Tools
For the pp files
IlluPak
For the love of god can someone fix this because the illupak is no longer there!!!!!
For the lst files
Darkhound's lst tools (A set of tools to create files to be used with LST_INSERT logic implemented in SB3 Wizzard)
Nobody123's lst toolset (Teo tools to decode/encode lst files once they have been unpacked from a pp file with Illupak)
Other modding tools
xx toolset (Basic toolset similar to Ilupak that only extracts and repacks .xx files)
SB3Utility (Rewrite of the RLUtility for SB3)
RLUtility (Post also includes a tutorial on how to work with xx files)
.xx file layout infomation
Additional .xx file format information
Darkhound's Illusion Morpher v0.1 (The program has been created to adjust mqo files in various ways. This includes adjusting/morphing one file to the shape of another, creation or recreation of symmetry in an object, closing of small gaps in models vertices without reducing vertex count, automatic refitting of clothes to the new shape, etc.)
For save game files
Darkhound's save game patcher v0.2 (outdated and replace by SB3 Wizzard)
To apply mods
Darkhound's SB3 Wizzard v0.5c (A tool to apply wizzard ready mods to SB3 with just a mouse click)
Common codes
...
124 is Bael's Original swimsuit.
141 is Maya's Default swimsuit.
15 is Maya's Original swimsuit.
62 is unnamed and unavaiilabe in regular gameplay. It is Bael's Reception Desk Uniform.
...
Categories: IllusionGamesSexy Beach 3
Navigation menu
...
Permanent link
Page information
This page was last modified on 29 March 2014, at 06:23.
Content is available under Creative Commons Attribution Non-Commercial Share Alike unless otherwise noted.
Privacy policyAbout Hgames WikiDisclaimersCreative Commons Attribution Non-Commercial Share AlikePowered by MediaWiki